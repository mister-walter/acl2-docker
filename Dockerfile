...
RUN mkdir /root/sbcl \
    && cd /root/sbcl \
    && wget "http://prdownloads.sourceforge.net/sbcl/sbcl-2.4.6-source.tar.bz2?download" -O sbcl.tar.bz2 -q \
    && echo "a489907842dae09a1726d62985bf7a56670aaea2f3eca1fb7023bca67c3f3091  sbcl.tar.bz2" > sbcl.tar.bz2.sha256 \
